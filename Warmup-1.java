    ...
    public boolean parrotTrouble(boolean talking, int hour) {
        if (talking && (hour < 7 || hour > 20 && hour <= 23)) return true;
        else return false;
    }
    ...
    public String front3(String str) {
        ...
        else if (length > 0 && length < 3) return str + str + str;
        else {
    ...
    public String startOz(String str) {
        if (str.length() < 2) return str;
            ...
            String char1 = "";
            String char2 = "";
            if (str.substring(0, 1).equals("o")) char1 = "o";
            if (str.substring(1, 2).equals("z")) char2 = "z";
            return char1 + char2;
        }
    }
    ...
    public int close10(int a, int b) {
        int aDiffer = Math.abs(10 - a);
        int bDiffer = Math.abs(10 - b);
        if (aDiffer == bDiffer) return 0;
        else if (aDiffer > bDiffer) return b;
        else return a;
    }
    ...
    public String endUp(String str) {
        if (str.length() < 3) return str.toUpperCase();
            ...
            String finish = str.substring(str.length() - 3, str.length()).toUpperCase();
            return start + finish;
        }
    }
